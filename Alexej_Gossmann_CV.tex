...
\begin{position}
  Design, mentoring, and guidance of an undergraduate research project applying machine learning methods to a large neuroimaging-genomics dataset, resulting in a presentation by the mentored undergraduate student, entitled ``Exploratory Analysis and Predictive Modeling of Neurodevelopmental Phenotypes from fMRI Data'' at the Health Sciences Research Days at Tulane University.
\end{position}
