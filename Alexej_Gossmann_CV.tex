...
\section{CONFERENCE PRESENTATIONS (talks and posters)}

\begin{itemize}
  \item Gossmann, A., Performance evaluation and regulatory considerations for AI/ML in medical imaging;
    Presented at \textit{KDD 2021 Health Day and 2021 KDD Workshop on Applied Data Science for Healthcare}, August 2021.
  \item
    Malik B., Cha K. H., Sahiner B., Gossmann, A., Software Pipelines for AI-Based Radiologic Image Analysis;
    Presented by Malik B. (summer intern student) at the \textit{2021 FDA Science Forum}.
  \item 
    ...
    Presented by Adkins-Chatfield T. A. (summer intern student) at \textit{the Annual Biomedical Research Conference for Minority Students (ABRCMS) 2020}.
  \item
    ...
    Presented by Cha K. H. (substitute due to travel complications of lead author) at the \textit{SPIE Medical Imaging Medical Imaging 2020: Computer-Aided Diagnosis},
  ...
  \item Gossmann A., Cha K. H., Sun X., Variational inference based assessment of mammographic lesion classification algorithms under distribution shift;
    Presented at \textit{Medical Imaging Meets NeurIPS Workshop (MED-NeurIPS) 2019},
