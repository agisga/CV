...
%{\sl Research Assistantship}
%\begin{itemize} \itemsep -2pt % Reduce space between items
%\item Development of statistical and machine learning methods for imaging-genomics in Dr. Yu-Ping Wang's group. January 2015 -- Present.
%\item Testing a linear correlation between two $L^2$ spatial fields, supervised by Dr. Gromenko, Tulane University, Department of Mathematics. June -- August 2014.
%\end{itemize}
